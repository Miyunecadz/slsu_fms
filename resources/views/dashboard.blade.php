...
<<<<<<< HEAD
                                        <a class="text-secondary text-truncate" href="{{route('dashboard', ['dir' => $module])}}"><i class="fas fa-folder p-1"></i> {{basename($module)}}</a>
...
=======
                                        ...
                                        @endif
>>>>>>> 948ad856c2b5df5110ad5a339c08d32472a86504
                                    </div>
